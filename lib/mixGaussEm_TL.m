function [label, model, llh] = mixGaussEm_TL(X, init)
...
%   llh: loglikelihood
% Written by Mo Chen (sth4nth@gmail.com) but altered by Nori Jacoby
%% init
...
for i = 1:k
    ...
    Sigma(:,:,i) = Xo*Xo'/nk(i) + eye(d)*(lambda); % regularize covariance
end
