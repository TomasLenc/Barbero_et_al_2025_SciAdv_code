...
save_path = fullfile(par.deriv_path, 'summary_comparisons', 'compare_eeg_X_mX'); 
mkdir(save_path); 
...
fname_save_base = fullfile(save_path, ...
        sprintf('response-%s_featStim-%s_harm-%s_concatEp-%s_snr-%s_roi-%s_avgChans-%s_feat-XvsmX', ...
                         response, ...
                         feat_name_stim, ...
                         harm_str, ...
                         jsonencode(concat_ep), ...
