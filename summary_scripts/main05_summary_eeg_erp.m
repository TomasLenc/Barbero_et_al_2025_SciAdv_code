% Summarize RSA results for ERP EEG. 
...
lpf_cutoff = par.filt_erp_cut_low; 
...
fname_save_base = fullfile(save_path, ...
        sprintf('response-%s_feat-erp_featStim-%s_lfp-%.0fHz_roi-%s_avgChans-%s', ...
                         response, ...
                         feat_name_stim, ...
                         lpf_cutoff, ...
                         roi_name, ...
...
fname_tbl = sprintf('response-%s_feat-erp_featStim-%s_lfp-%.0fHz_roi-%s_avgChans-%s.csv', ...
                         response, ...
                         feat_name_stim, ...
                         lpf_cutoff, ...
                         roi_name, ...
